package com.zoomtech.emm.features.progress;
...
import com.zoomtech.emm.BuildConfig;
...
public class CircleProgress extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //求最小值作为实际值
        int minSize = Math.max(w - getPaddingLeft() - getPaddingRight() - 2 * (int) maxArcWidth,
        ...
        //mUnitOffset = mCenterPoint.x + MiscUtil.measureTextWidth(mValuePaint,String.format(mPrecisionFormat, mValue));
        updateArcPaint();
    ...
    private void drawText(Canvas canvas) {
        ...
        if (mUnit != null) {
            ...
            //canvas.drawText(mUnit.toString(), mUnitOffset, mValueOffset, mUnitPaint);
        }
    }
    ...
    private void drawArc(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, 3, currentAngle, false, mArcPaint);
        canvas.restore();
    }
    ...
    public void setValue(float value) {
        ...
        //modify by duanxin for bug225 on 2017.10.11
        float end = 0;
        if (value != 0) {
            end = value / mMaxValue;
        }
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (BuildConfig.DEBUG) {
                    /*Log.w(TAG, "onAnimationUpdate: percent = " + mPercent
