package com.zoomtech.emm.features.QR.zxing.activity;
...
import com.zoomtech.emm.features.QR.zxing.camera.CameraManager;
import com.zoomtech.emm.features.QR.zxing.decoding.CaptureActivityHandler;
import com.zoomtech.emm.features.QR.zxing.decoding.InactivityTimer;
import com.zoomtech.emm.features.QR.zxing.decoding.RGBLuminanceSource;
import com.zoomtech.emm.features.QR.zxing.view.ViewfinderView;
   ...
   /* @Override
    public void onCreate(Bundle savedInstanceState) {
       ...
       // back = (ImageView) findViewById(R.id.scanner_toolbar_back);
        /*back.setOnClickListener(ne View.OnClickListener() {
            @Override
...
//                //打开手机中的相册
//                Intent innerIntent = ne Intent(Intent.ACTION_GET_CONTENT); //"android.intent.action.GET_CONTENT"
...
//                                bundle.putParcelable("bitmap",result.get);
    ...
    protected void onResume() {
        ...
        //quit the scan view
//		cancelScanButton.setOnClickListener(ne OnClickListener() {
//
//			@Override
//			public void onClick(View v) {
...
//		});
    ...
    protected void initView() {
        CameraManager.init(getApplication());
        viewfinderView = (ViewfinderView) mViewHolder.get(R.id.viewfinder_content);
        hasSurface = false;
        inactivityTimer = new InactivityTimer(this);
