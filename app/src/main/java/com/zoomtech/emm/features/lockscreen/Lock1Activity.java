...
import com.zoomtech.emm.features.lockscreen.widget.PasswordTextView;
 ...
 */
public class Lock1Activity extends BaseActivity implements View.OnClickListener {
   ...
   /* @Override
    ...
    protected void initView() {
        LogUtil.writeToFile("Lock1Activity","");
        ...
        et_pwd4.setOnTextChangedListener(new PasswordTextView.OnTextChangedListener() {
            ...
            public void textChanged(String content) {
                ...
                if (type == Consts.SETTING_PASSWORD) {//设置密码
                    ...
                    if (!input.equals(PreferencesManager.getSingleInstance().getLockPassword("password"))) {
                    ...
                    if (input.equals(fBuffer.toString())) {//一致
                        ...
                        //保存密码到文件中
                        PreferencesManager.getSingleInstance().setLockPassword("password",input);
