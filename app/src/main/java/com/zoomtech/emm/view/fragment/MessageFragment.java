...
import com.zoomtech.emm.view.activity.MessageDetailActivity;
import com.zoomtech.emm.view.adapter.MessageAdapter;
...
public class MessageFragment extends BaseFragment implements ListView.OnItemClickListener{
    ...
    protected void initView(View view) {
        ...
        mListView = mViewHolder.get(R.id.message_list);
        //mListView.addFooterView(new ViewStub(getActivity()));
