...
public class VPNUtils {
    ...
    public static void resetVpn(final Context context,final  Object profile) {
    ...
    public static void disconnect(Context context) {
       /* ConnectivityManager cm = (ConnectivityManager) context
        ...
        try {
            ...
            Method getUserId = userHandleClass.getMethod("getUserId", int.class);
            getUserId.setAccessible(true);
             int userId  = (int) getUserId.invoke(userHandleClass, info.uid);
            metPrepare.invoke(objIConManager, "[Legacy VPN]", "[Legacy VPN]",userId);
