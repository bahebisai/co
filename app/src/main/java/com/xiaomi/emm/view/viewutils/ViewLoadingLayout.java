...
public class ViewLoadingLayout extends LinearLayout implements View.OnClickListener {// , ISkinUIObserver {
    ...
    View view;
    private ViewLoaddingInterface viewLoaddingInterface;//自定义回调接口
    String nodate;                                         //没有数据显示的文字
    String[] btn_text;                                     //按钮数组
    int noDataImgId = -1;                                      //没有数据的图片数据源
    String title;                                          //没有数据的问题,替换好凄凉那个地方

    public void setViewLoaddingInterface(ViewLoaddingInterface viewLoaddingInterface) {
        this.viewLoaddingInterface = viewLoaddingInterface;
    }


    /**
     * @param viewLoaddingInterface 回调接口
     * @param nodate                没数据显示的文字        ,为空默认
     * @param btn_text              按钮数组,数组长度可为1,2,为空木有按钮
     */
    public void setInit(ViewLoaddingInterface viewLoaddingInterface, String nodate, String[] btn_text) {
        setViewLoaddingInterface( viewLoaddingInterface );
        this.nodate = nodate;
     ...
     */
    public void setInit(ViewLoaddingInterface viewLoaddingInterface, String nodate, String[] btn_text, int noDataImgId, String title) {
        setInit( viewLoaddingInterface, nodate, btn_text );
          ...
          //      Log.e( TAG, "--------NETWORK_ERROR---------------" );
            ...
            case NODATA:
             ...
             //   Log.e( TAG, "--------NETWORK_LOADING---------------" );
                ...
                if (btn_text != null && viewLoaddingInterface != null) {
                    OnClickListener onClickListener = new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            viewLoaddingInterface.NoDate( v.getId() );
                        }
                    };
                }
